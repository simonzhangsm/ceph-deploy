...
class TestParserRepo(object):
    ...
    def test_repo_url_custom_path(self):
        args = self.parser.parse_args('repo ceph --repo-url http://mirrors.ustc.edu.cn/ceph host1'.split())
        assert args.repo_url == "http://mirrors.ustc.edu.cn/ceph"
    ...
    def test_repo_gpg_url_custom_path(self):
        args = self.parser.parse_args('repo ceph --gpg-url http://mirrors.ustc.edu.cn/ceph/key host1'.split())
        assert args.gpg_url == "http://mirrors.ustc.edu.cn/ceph/key"
