...
class TestParserInstall(object):
    ...
    def test_install_repo_url_custom_path(self):
        args = self.parser.parse_args('install --repo-url http://mirrors.ustc.edu.cn/ceph host1'.split())
    ...
    def test_install_gpg_url_custom_path(self):
        args = self.parser.parse_args('install --gpg-url http://mirrors.ustc.edu.cn/ceph/key host1'.split())
